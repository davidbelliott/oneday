...
WordList::WordList()
	...
	TAKE(add_word({ "take", { "grab", "snatch", "get", "obtain", "pick up", "remove" }, Word::ACTION })),
	WEAR(add_word({"wear", {"don", "put on"}, Word::ACTION})),
	...
	DROP(add_word({ "drop", { "put down", "discard" }, Word::ACTION })),
	PUT_IN_CONTAINER(add_word({ "put in", { }, Word::ACTION })),
